...
# Import PPO and configuration from TRL.
...
TRAIN_JSON_PATH = "/home/n/Token-Book/eval/Benchmark/grade-school-math/grade_school_math/data/train.jsonl"
...
class ChainOfThoughtDataset(Dataset):
    def __init__(self, tokenizer, json_file, block_size=256):
        ...
        with open(json_file, 'r', encoding='utf-8') as f:
            for line in f:
                data = json.loads(line)  # Corrected: using 'line' instead of 'f'
...
def extract_ground_truth(query_text):
    """
    A simple regex to find the answer of the llm?
    """
    match = re.search(r'####:\s*([a-zA-Z0-9]+)', query_text)
    if match:
        ...
        for step, batch in enumerate(dataloader):
            ...
            for query in queries:
                ...
                response_ids = model.generate(
                    ...
                    max_new_tokens=256,  # Control the number of tokens generated
                    temperature=0.6,
                    top_p=0.9,
                    do_sample=True,
